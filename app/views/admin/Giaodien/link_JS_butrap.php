...
<!-- Custom Js -->
<script src="../app/views/admin/js/admin.js"></script>

<script src="../app/views/admin/js/pages/tables/jquery-datatable.js"></script>
<!-- Demo Js -->
<script src="../app/views/admin/js/demo.js"></script>
